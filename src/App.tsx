...
import { MorningAgentsAndBetaSuite } from './components/MorningAgentsAndBetaSuite';
...
function MainApp() {
  ...
  // Automatically direct to the landing page whenever the user logs out
  useEffect(() => {
